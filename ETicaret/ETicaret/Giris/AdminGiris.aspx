<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminGiris.aspx.cs" Inherits="ETicaret.Giris.AdminGiris" %>
		...
		<div class="card  align-self-center">
			...
			<div class="card-body">
					...
					<div class="form-group">
                        <asp:Button ID="adminGiris" runat="server" Text="Giriş Yap" class="btn float-right login_btn" OnClick="adminGiris_Click" />
